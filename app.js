...
fridayComs.push("open amazon prime");
...
recognition.onresult = function (event) {
  ...
  if(localStorage.getItem("lang") === "en-US"){
    ...
    if (transcript.includes("how much charge do I have")) {
  ...
  // amazon prime
    if (transcript.includes("open amazon prime")) {
      readOut("opening netlify");
      let a = window.open("https://www.primevideo.com/?ref_=dvm_pds_amz_in_as_s_gm_159_mkw_sRumWk2Nj-dc&mrntrk=pcrid_694649444338_slid__pgrid_84577172328_pgeo_9144063_x__adext__ptid_kwd-303629226711");
      windowsB.push(a)
    }

    if (transcript.includes("Play Series")) {
      readOut("here's your result");
      let input = transcript.split("");
      input.splice(0, 11);
      input.pop();
      input = input.join("").split(" ").join("+");
      let a = window.open(`https://www.primevideo.com/search?q=${input}`);
      windowsB.push(a)
    }
  ...
  // spotify
    ...
    if (transcript.includes("open my canva designs")) {
      ...
      window.open("https://www.canva.com/design/DAGLTBwdsh4/C1gCA918RXAWkFCsYBZFPw/edit");
    }
    ...
    if (transcript.includes("open youtube")) {
      ...
      let a = window.open("https://www.youtube.com/@saimurarichikkam8115");
      windowsB.push(a)
    }
    ...
    if (transcript.includes("play")) {
      ...
      let a = window.open(`https://www.youtube.com/results?search_query=${videoName}`
      );
      windowsB.push(a)
    }
    ...
    if (transcript.includes("open instagram")) {
      ...
      let a =window.open("https://www.instagram.com/nameissaimurari/");
      windowsB.push(a)
    }
    if (transcript.includes("open my instagram profile")) {
      if (JSON.parse(userData).instagram) {
        ...
        readOut("sir i didn't find your instagram information");
      }
    }
    // twitter
    ...
    if (transcript.includes("open my github profile")) {
      ...
      let a = window.open(`https://github.com/Murari-ch`);
      windowsB.push(a)
    }
